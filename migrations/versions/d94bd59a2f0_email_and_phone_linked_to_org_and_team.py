...
def upgrade():
    ...
    op.alter_column('useremail', 'user_id',
    ...
    op.alter_column('useremailclaim', 'user_id',
        existing_type=sa.INTEGER(),
        nullable=True)
    op.create_index(op.f('ix_useremailclaim_email'), 'useremailclaim', ['email'], unique=False)
    op.create_index(op.f('ix_useremailclaim_md5sum'), 'useremailclaim', ['md5sum'], unique=False)
    op.create_unique_constraint('useremailclaim_org_id_email_key', 'useremailclaim', ['org_id', 'email'])
    op.create_unique_constraint('useremailclaim_team_id_email_key', 'useremailclaim', ['team_id', 'email'])
    ...
    op.alter_column('userphone', 'user_id',
        existing_type=sa.INTEGER(),
        nullable=True)
    ...
    op.alter_column('userphoneclaim', 'user_id',
        existing_type=sa.INTEGER(),
        nullable=True)
    op.create_index(op.f('ix_userphoneclaim_phone'), 'userphoneclaim', ['phone'], unique=False)
    op.create_unique_constraint('userphoneclaim_team_id_phone_key', 'userphoneclaim', ['team_id', 'phone'])
    op.create_unique_constraint('userphoneclaim_org_id_phone_key', 'userphoneclaim', ['org_id', 'phone'])
...
def downgrade():
    ...
    op.drop_constraint('userphoneclaim_team_id_fkey', 'userphoneclaim', type_='foreignkey')
    op.drop_constraint('userphoneclaim_org_id_fkey', 'userphoneclaim', type_='foreignkey')
    op.drop_constraint('userphoneclaim_team_id_phone_key', 'userphoneclaim', type_='unique')
    op.drop_constraint('userphoneclaim_org_id_phone_key', 'userphoneclaim', type_='unique')
    ...
    op.drop_constraint('userphone_user_id_or_org_id_or_team_id', 'userphone', type_='check')
    ...
    op.drop_constraint('useremailclaim_user_id_or_org_id_or_team_id', 'useremailclaim', type_='check')
    op.drop_constraint('useremailclaim_team_id_fkey', 'useremailclaim', type_='foreignkey')
    op.drop_constraint('useremailclaim_org_id_fkey', 'useremailclaim', type_='foreignkey')
    op.drop_constraint('useremailclaim_team_id_email_key', 'useremailclaim', type_='unique')
    op.drop_constraint('useremailclaim_org_id_email_key', 'useremailclaim', type_='unique')
    ...
    op.drop_constraint('useremail_user_id_or_org_id_or_team_id', 'useremail', type_='check')
